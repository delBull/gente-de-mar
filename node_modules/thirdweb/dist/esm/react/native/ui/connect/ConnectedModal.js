...
export function ConnectedModal(props) {
    ...
    switch (modalState.screen) {
        ...
        case "receive": {
            content = (_jsx(ReceiveScreen, { account: props.account, wallet: props.wallet, client: props.client, theme: theme, containerType: props.containerType, onBack: () => setModalState({ screen: "account" }), onClose: props.onClose }));
            break;
        }
        case "view_funds": {
