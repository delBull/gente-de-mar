...
export function SwapTxDetailsTable(props) {
    ...
    return (_jsxs("div", { children: [_jsx(TokenInfoRow, { chainId: fromToken.chainId, client: client, label: "Paid", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, isPartialSuccess && gotToken ? (
            // Expected + Got
            ...
            // Receive
            _jsx(TokenInfoRow, { chainId: toToken.chainId, client: client, label: "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })), _jsxs(_Fragment, { children: [lineSpacer, _jsxs(Container, { flex: "row", style: {
                            justifyContent: "space-between",
                        }, children: [_jsx(Text, { size: "sm", children: "Recipient" }), _jsx(WalletRow, { address: uiData.toAddress, iconSize: "sm", client: client })] })] }), statusMeta && showStatusRow && (_jsxs(_Fragment, { children: [lineSpacer, _jsxs(Container, { flex: "row", style: {
                            justifyContent: "space-between",
                        }, children: [_jsx(Text, { size: "sm", children: "Status" }), _jsx(Container, { flex: "column", gap: "3xs", center: "y", style: {
                                    alignItems: "flex-end",
                                }, children: _jsx(Text, { color: statusMeta.color, size: "sm", children: statusMeta.status }) })] })] })), _jsx(Spacer, { y: "lg" }), fromChainExplorers.explorers?.[0]?.url && sourceTxHash && (_jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl(fromChainExplorers.explorers[0]?.url, sourceTxHash), target: "_blank", gap: "xs", style: {
                ...
                toChainExplorers?.explorers?.[0]?.url && (_jsxs(_Fragment, { children: [_jsx(Spacer, { y: "sm" }), _jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: formatExplorerTxUrl(toChainExplorers.explorers[0]?.url, destinationTxHash), target: "_blank", gap: "xs", style: {
                            fontSize: fontSize.sm,
                            padding: spacing.sm,
