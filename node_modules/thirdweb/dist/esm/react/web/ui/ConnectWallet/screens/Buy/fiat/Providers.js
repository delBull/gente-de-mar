...
export function Providers(props) {
    return (_jsx(Container, { expand: true, flex: "column", gap: "sm", style: {
            alignItems: "flex-start",
        }, children: props.supportedProviders.map((provider) => (_jsx(Container, { flex: "row", expand: true, style: {
                justifyContent: "space-between",
                        ...
                        ? "primaryText"
                        : "secondaryText", size: "sm", hoverColor: "primaryText", children: getProviderLabel(provider) }) }) }, provider))) }));
}
