...
function BuyScreenContent(props) {
    ...
    if (screen.id === "fiat-flow" && payer) {
        ...
        return (_jsx(OnRampScreen, { title: props.title, transactionMode: payOptions.mode === "transaction", paymentLinkId: props.paymentLinkId, quote: screen.quote, onBack: () => {
                setScreen({
                    id: "buy-with-fiat",
                });
    ...
    if (screen.id === "select-to-token") {
        ...
        return (_jsx(TokenSelector, { onBack: goBack, tokenList: ((toChain?.id ? destinationSupportedTokens[toChain.id] : undefined) ||
                []).filter((x) => x.address.toLowerCase() !== NATIVE_TOKEN_ADDRESS.toLowerCase()), onTokenSelect: (tokenInfo) => {
    ...
    return (_jsx(Container, { animate: "fadein", children: _jsxs("div", { children: [screen.id === "main" && (_jsx(MainScreen, { title: props.title, payerAccount: payer?.account, client: client, onSelectBuyToken: () => setScreen({ id: "select-to-token", backScreen: screen }), payOptions: payOptions, setTokenAmount: setTokenAmount, setToChain: setToChain, setToToken: setToToken, setFromChain: setFromChain, setFromToken: setFromToken, toChain: toChain, toToken: toToken, tokenAmount: tokenAmount, connectOptions: props.connectOptions, setScreen: setScreen, supportedDestinations: supportedDestinations, onBack: props.onBack, theme: props.theme, hasEditedAmount: hasEditedAmount, setHasEditedAmount: setHasEditedAmount, enabledPaymentMethods: enabledPaymentMethods })), (screen.id === "select-payment-method" ||
                    ...
                    }, children: [screen.id === "buy-with-crypto" && activeAccount && (_jsx(SwapScreenContent, { setScreen: setScreen, paymentLinkId: props.paymentLinkId, tokenAmount: deferredTokenAmount, toChain: toChain, toToken: toToken, fromChain: fromChain, fromToken: fromToken, showFromTokenSelector: () => {
                                setScreen({
                                    id: "select-from-token",
                                    backScreen: screen,
                                });
...
function MainScreen(props) {
    ...
    switch (payOptions.mode) {
        ...
        default: {
            return (_jsxs(Container, { px: "lg", children: [_jsx(Spacer, { y: "lg" }), _jsx(ModalHeader, { title: props.title, onBack: props.onBack }), _jsx(Spacer, { y: "xl" }), _jsx(BuyTokenInput, { value: tokenAmount, onChange: async (value) => {
                            ...
                            }, children: "Continue" })) }), _jsx(Spacer, { y: "lg" }), payOptions.showThirdwebBranding !== false && (_jsxs(_Fragment, { children: [_jsx(PoweredByThirdweb, { link: "https://playground.thirdweb.com/connect/pay?utm_source=ub_text" }), _jsx(Spacer, { y: "sm" })] }))] }));
        }
    }
}
