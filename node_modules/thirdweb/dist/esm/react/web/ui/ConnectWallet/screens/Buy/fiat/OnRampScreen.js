...
function StepUI(props) {
    ...
    return (_jsx(Container, { flex: "column", gap: "xs", py: "3xs", children: _jsxs(Container, { flex: "row", center: "y", gap: "sm", style: {
                ...
                flexWrap: "nowrap",
                    ...
                    } }), _jsxs(Container, { flex: "column", gap: "3xs", center: "y", style: { flex: "1" }, children: [_jsx(Text, { size: "sm", color: "primaryText", children: getProviderLabel(step.action) }), _jsxs(Container, { flex: "row", gap: "xs", center: "y", style: {
                                display: "flex",
                                justifyContent: "space-between",
                                flexWrap: "nowrap",
