...
export const Spinner = (props) => {
    ...
    return (_jsx(Svg, { style: {
        ...
        }, viewBox: "0 0 50 50", children: _jsx(Circle, { cx: "25", cy: "25", r: "20", fill: "none", stroke: props.color ? theme.colors[props.color] : "currentColor", strokeWidth: Number(iconSize[props.size]) > 64 ? "2" : "4" }) }));
};
// animations
