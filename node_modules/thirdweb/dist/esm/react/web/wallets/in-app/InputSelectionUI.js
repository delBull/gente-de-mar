...
export function InputSelectionUI(props) {
    ...
    return (_jsxs("div", { style: {
            width: "100%",
                    ...
                    display: "flex",
                    flexDirection: "row",
                }, "data-error": renderingError, children: [props.format === "phone" && (_jsx(CountrySelector, { countryCode: countryCodeInfo, setCountryCode: setCountryCodeInfo, allowedCountryCodes: props.allowedSmsCountryCodes })), _jsx(Input, { tabIndex: -1, placeholder: props.placeholder, style: {
                            flexGrow: 1,
