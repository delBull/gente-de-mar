    ...
    return (_jsxs(Container, { flex: "column", gap: "md", style: {
            position: "relative",
                ...
                (inputMode === "phone" ? (_jsx(InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                        ...
                        return undefined;
                    }, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, submitButtonText: locale.submitEmail, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes })) : (_jsx(WalletTypeRowButton, { client: props.client, icon: PhoneIcon, onClick: () => {
                    ...
                    handlePassKeyLogin();
                }, title: locale.passkey, disabled: props.disabled })), siweEnabled && !props.isLinking && (_jsx(WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
