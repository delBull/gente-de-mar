...
import { isTotalSupplySupported, totalSupply, } from "../__generated__/IERC721A/read/totalSupply.js";
 ...
 * ```
 */
export function isGetNFTsSupported(availableSelectors) {
    return (isGetNFTSupported(availableSelectors) &&
