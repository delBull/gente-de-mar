...
function ConnectedModal(props) {
    ...
    switch (modalState.screen) {
        ...
        case "receive": {
            content = ((0, jsx_runtime_1.jsx)(ReceiveScreen_js_1.ReceiveScreen, { account: props.account, wallet: props.wallet, client: props.client, theme: theme, containerType: props.containerType, onBack: () => setModalState({ screen: "account" }), onClose: props.onClose }));
            break;
        }
        case "view_funds": {
