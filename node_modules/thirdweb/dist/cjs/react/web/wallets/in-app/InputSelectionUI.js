...
function InputSelectionUI(props) {
    const [countryCodeInfo, setCountryCodeInfo] = (0, react_1.useState)(props.defaultSmsCountryCode
        ? (0, CountrySelector_js_1.getCountrySelector)(props.defaultSmsCountryCode)
        : props.allowedSmsCountryCodes &&
            props.allowedSmsCountryCodes.length > 0 &&
            props.allowedSmsCountryCodes[0]
            ? (0, CountrySelector_js_1.getCountrySelector)(props.allowedSmsCountryCodes[0])
            : "US +1");
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            width: "100%",
                    ...
                    display: "flex",
                    flexDirection: "row",
                }, "data-error": renderingError, children: [props.format === "phone" && ((0, jsx_runtime_1.jsx)(CountrySelector_js_1.CountrySelector, { countryCode: countryCodeInfo, setCountryCode: setCountryCodeInfo, allowedCountryCodes: props.allowedSmsCountryCodes })), (0, jsx_runtime_1.jsx)(formElements_js_1.Input, { tabIndex: -1, placeholder: props.placeholder, style: {
                            flexGrow: 1,
