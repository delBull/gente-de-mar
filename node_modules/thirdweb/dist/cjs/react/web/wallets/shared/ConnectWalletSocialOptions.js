    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
                ...
                (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                        ...
                        return undefined;
                    }, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, submitButtonText: locale.submitEmail, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: PhoneIcon_js_1.PhoneIcon, onClick: () => {
                    ...
                    handlePassKeyLogin();
                }, title: locale.passkey, disabled: props.disabled })), siweEnabled && !props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
