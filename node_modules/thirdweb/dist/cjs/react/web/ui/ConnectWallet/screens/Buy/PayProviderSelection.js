...
const PayProviderSelection = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
            ...
            borderStyle: "solid",
            borderBottom: "none",
        }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryText", children: "Provider" }), props.supportedProviders.length > 1 ? ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "ghost", onClick: props.onShowProviders, style: { padding: 0 }, children: ProviderItem })) : (ProviderItem)] }));
};
