...
function Modal(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: (0, jsx_runtime_1.jsx)(ConnectModal_js_1.default, { onClose: props.onClose, shouldSetActive: props.setActive === undefined ? true : props.setActive, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: props.chain, client: props.client, connectLocale: props.connectLocale, meta: meta, size: size, welcomeScreen: props.welcomeScreen, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, hiddenWallets: props.hiddenWallets, wallets: wallets, chains: props.chains, walletConnect: props.walletConnect }) }));
}
