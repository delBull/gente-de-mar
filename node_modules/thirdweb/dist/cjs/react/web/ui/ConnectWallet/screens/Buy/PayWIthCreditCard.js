...
function PayWithCreditCard(props) {
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
            ...
            alignItems: "center",
        }, children: [(0, jsx_runtime_1.jsxs)(CurrencyButton, { variant: "ghost", onClick: props.onSelectCurrency, style: {
                    minHeight: "64px",
                    justifyContent: "flex-start",
                    minWidth: "50%",
                }, gap: "sm", children: [(0, currencies_js_1.getFiatIcon)(props.currency, "md"), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", gap: "xxs", color: "secondaryText", children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: props.currency.shorthand }), (0, jsx_runtime_1.jsx)(react_icons_1.ChevronDownIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm })] })] }), (0, jsx_runtime_1.jsx)("div", { style: {
                    flexGrow: 1,
                    flexShrink: 1,
                    display: "flex",
                ...
                }, children: props.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_1.fontSize.lg })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "lg", color: props.value ? "primaryText" : "secondaryText", children: props.value
