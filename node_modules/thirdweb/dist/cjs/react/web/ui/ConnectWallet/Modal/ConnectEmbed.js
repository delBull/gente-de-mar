...
function ConnectEmbed(props) {
    ...
    const autoConnectComp = props.autoConnect !== false && ((0, jsx_runtime_1.jsx)(AutoConnect_js_1.AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, siweAuth: siweAuth, wallets: wallets, accountAbstraction: props.accountAbstraction, timeout: typeof props.autoConnect === "boolean"
            ? undefined
    ...
    if (show) {
        ...
        return ((0, jsx_runtime_1.jsxs)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: [(0, jsx_runtime_1.jsx)(ConnectEmbedContent, { auth: props.auth, accountAbstraction: props.accountAbstraction, chain: preferredChain, chains: props.chains, client: props.client, connectLocale: localeQuery.data, size: modalSize, meta: meta, header: props.header, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets: wallets, className: props.className, modalSize: modalSize, style: props.style, welcomeScreen: props.welcomeScreen, hiddenWallets: props.hiddenWallets }), autoConnectComp] }));
    }
    ...
    if (isAutoConnecting) {
        ...
        content = ((0, jsx_runtime_1.jsx)(ConnectModalContent_js_1.ConnectModalContent, { shouldSetActive: true, screenSetup: screenSetup, isOpen: true, onClose: () => {
                ...
                titleIconUrl: typeof props.header === "object"
                    ...
                    : undefined,
            }, size: props.size, welcomeScreen: props.welcomeScreen, hideHeader: !props.header, onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets: props.wallets, modalHeader: undefined, walletIdsToHide: props.hiddenWallets }));
    }
    return ((0, jsx_runtime_1.jsx)(exports.EmbedContainer, { modalSize: modalSize, className: props.className, style: props.style, children: modalSize === "wide" ? (content) : ((0, jsx_runtime_1.jsxs)(DynamicHeight_js_1.DynamicHeight, { children: [" ", content, " "] })) }));
};
