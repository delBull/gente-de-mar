...
function ConnectButton(props) {
    ...
    const autoConnectComp = props.autoConnect !== false && ((0, jsx_runtime_1.jsx)(AutoConnect_js_1.AutoConnect, { chain: preferredChain, appMetadata: props.appMetadata, client: props.client, wallets: wallets, timeout: typeof props.autoConnect === "boolean"
            ? undefined
            : props.autoConnect?.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect, siweAuth: siweAuth }));
    if (!localeQuery.data) {
        const combinedClassName = `${props.connectButton?.className || ""} ${TW_CONNECT_WALLET}`;
        return ((0, jsx_runtime_1.jsxs)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
                minWidth: "165px",
                height: "50px",
    ...
    return ((0, jsx_runtime_1.jsxs)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: [(0, jsx_runtime_1.jsx)(ConnectButtonInner, { ...props, siweAuth: siweAuth, connectLocale: localeQuery.data }), (0, jsx_runtime_1.jsx)(ConnectModal_js_1.default, { shouldSetActive: true, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: preferredChain, chains: props.chains, client: props.client, connectLocale: localeQuery.data, meta: {
                ...
                }, welcomeScreen: props.connectModal?.welcomeScreen, size: size, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, hiddenWallets: hiddenWallets, walletConnect: props.walletConnect, wallets: wallets }), autoConnectComp] }));
}
function ConnectButtonInner(props) {
    ...
    if (!activeAccount) {
        ...
        const combinedClassName = `${props.connectButton?.className || ""} ${TW_CONNECT_WALLET}`;
        return ((0, jsx_runtime_1.jsx)(AnimatedButton, { disabled: isLoading, className: combinedClassName, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
                minWidth: "165px",
                height: "50px",
                fontSize: "16px",
                ...props.connectButton?.style,
                ...
                : typeof connectButtonLabel === "string"
                    ? connectButtonLabel
                    : locale.defaultButtonTitle, onClick: () => {
    ...
    if (siweAuth.requiresAuth) {
        ...
        if (siweAuth.isPending || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
            ...
            return ((0, jsx_runtime_1.jsx)(AnimatedButton, { disabled: true, className: combinedClassName, variant: "primary", type: "button", style: {
                    ...
                    height: "50px",
                    ...props.connectButton?.style,
                }, children: (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "sm", color: "primaryButtonText" }) }));
        }
        // sign in button + modal if *not* loading and *not* logged in
        if (!siweAuth.isLoggedIn) {
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "primary", type: "button", onClick: () => {
                            setShowSignatureModal(true);
                        }, className: props.signInButton?.className, style: {
                            minWidth: "165px",
                            minHeight: "50px",
                            ...props.signInButton?.style,
                        }, children: siweAuth.isLoggingIn ? ((0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "sm", color: "primaryButtonText" })) : ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", gap: "sm", children: [(0, jsx_runtime_1.jsx)(LockIcon_js_1.LockIcon, { size: index_js_1.iconSize.sm }), (0, jsx_runtime_1.jsxs)("span", { children: [" ", props.signInButton?.label || locale.signIn, " "] })] })) }), (0, jsx_runtime_1.jsx)(Modal_js_1.Modal, { size: "compact", open: showSignatureModal, setOpen: setShowSignatureModal, children: (0, jsx_runtime_1.jsx)(SignatureScreen_js_1.SignatureScreen, { client: props.client, connectLocale: locale, modalSize: "compact", termsOfServiceUrl: props.connectModal?.termsOfServiceUrl, privacyPolicyUrl: props.connectModal?.privacyPolicyUrl, onDone: () => setShowSignatureModal(false), auth: props.auth }) })] }));
        }
        // otherwise, show the details button
    }
    return ((0, jsx_runtime_1.jsx)(provider_js_1.AccountProvider, { address: activeAccount.address, client: props.client, children: (0, jsx_runtime_1.jsx)(Details_js_1.ConnectedWalletDetails, { theme: theme, detailsButton: props.detailsButton, detailsModal: {
                ...props.detailsModal,
                hiddenWallets: hiddenWallets,
            }, supportedTokens: supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
                // logout on explicit disconnect!
                if (siweAuth.requiresAuth) {
                    siweAuth.doLogout();
                }
                props.onDisconnect?.(info);
            }, chains: props?.chains || [], chain: props.chain, switchButton: props.switchButton, client: props.client, connectLocale: locale, connectOptions: {
