...
exports.isUpdateMetadataSupported = isUpdateMetadataSupported;
const BatchBaseURI = require("../../__generated__/DropERC721/write/updateBatchBaseURI.js");
const BaseURICount = require("../../__generated__/IBatchMintMetadata/read/getBaseURICount.js");
const BatchAtIndex = require("../../__generated__/IBatchMintMetadata/read/getBatchIdAtIndex.js");
const GetNFT = require("../../read/getNFT.js");
/**
 * @internal
 */
async function getUpdateMetadataParams(options) {
    ...
    const batchOfUris = await uploadOrExtractURIs(newMetadatas, contract.client, Number(startTokenId));
...
function isUpdateMetadataSupported(availableSelectors) {
    return (BaseURICount.isGetBaseURICountSupported(availableSelectors) &&
