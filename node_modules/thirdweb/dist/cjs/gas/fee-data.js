...
async function getGasOverridesForTransaction(transaction) {
    ...
    const [maxFeePerGas, maxPriorityFeePerGas, gasPrice, type] = await Promise.all([
        ...
        (0, resolve_promised_value_js_1.resolvePromisedValue)(transaction.gasPrice),
        (0, resolve_promised_value_js_1.resolvePromisedValue)(transaction.type),
    ]);
