...
const extractMinimalProxyImplementationAddress_js_1 = require("./extractMinimalProxyImplementationAddress.js");
...
contract) {
    ...
    const minimalProxyImplementationAddress = (0, extractMinimalProxyImplementationAddress_js_1.extractMinimalProxyImplementationAddress)(originalBytecode);
    if (minimalProxyImplementationAddress) {
        return {
            address: minimalProxyImplementationAddress,
            bytecode: await (0, get_bytecode_js_1.getBytecode)((0, contract_js_1.getContract)({
                ...contract,
                address: minimalProxyImplementationAddress,
            })),
        };
