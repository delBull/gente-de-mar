...
exports.processOverrideList = processOverrideList;
...
async function processOverrideList(options) {
    ...
    for (const [shardId, entries] of Object.entries(shards)) {
        ...
        shardsToUpload.push({
            data: (0, json_js_1.stringify)(data),
            name: `${shardId}.json`,
        });
    }
    ...
    const originalEntriesUri = await (0, upload_js_1.upload)({
        client: options.client,
        files: [(0, json_js_1.stringify)(options.overrides)],
    });
...
//# sourceMappingURL=process-override-list.js.map